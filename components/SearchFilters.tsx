      ...
      <PopoverContent className="w-80 p-4" align="end">
        <div className="space-y-4">
          ...
          <div className="space-y-4 max-h-80 overflow-y-auto">
            {/* City Filter */}
            <div>
              <label htmlFor="filter-city" className="block text-sm font-medium mb-2">City</label>
              <select
                id="filter-city"
                value={filters.city || ''}
            ...
            {/* Rating Filter */}
            <div>
              <label htmlFor="filter-rating" className="block text-sm font-medium mb-2">Minimum Rating</label>
              <select
                id="filter-rating"
