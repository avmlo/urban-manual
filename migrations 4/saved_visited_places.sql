-- Migration: Create saved_places and visited_places tables for Supabase
...
CREATE INDEX IF NOT EXISTS idx_saved_places_destination_slug ON saved_places(destination_slug);
CREATE INDEX IF NOT EXISTS idx_visited_places_user_id ON visited_places(user_id);
CREATE INDEX IF NOT EXISTS idx_visited_places_destination_slug ON visited_places(destination_slug);
