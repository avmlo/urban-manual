...
export default function InteractiveHero() {
  ...
  return (
    <div className="sticky top-0 z-40 w-full px-4 sm:px-6 md:px-10 pt-4 pb-3">
      {/* Floating search overlay with glass effect */}
      <div className="w-full max-w-2xl mx-auto">
          {/* Search Input - Floating glass style */}
          <form onSubmit={handleSearch} className="mb-0">
            <div className="relative">
              ...
              <input
                ...
                className="w-full h-12 pl-11 pr-14 text-sm rounded-full shadow-lg
                           bg-[var(--editorial-bg-elevated)]/80 backdrop-blur-xl
                           border border-[var(--editorial-border)]/50 text-[var(--editorial-text-primary)]
              ...
              <button
                ...
                className="absolute right-2 top-1/2 -translate-y-1/2 w-8 h-8 flex items-center justify-center
                           rounded-full bg-[var(--editorial-text-primary)]
              ...
              {showInstantResults && !showChatResults && (instantResults.length > 0 || instantSuggestions.length > 0) && (
                <div
                  ref={dropdownRef}
                  className="absolute top-full left-0 right-0 mt-2 bg-[var(--editorial-bg-elevated)]/90 backdrop-blur-xl
                             rounded-2xl shadow-xl border border-[var(--editorial-border)]/50
          ...
          {/* AI Chat Results - dropdown panel below search */}
          {showChatResults && (
            <div className="mt-3 p-4 rounded-2xl bg-[var(--editorial-bg-elevated)]/90 backdrop-blur-xl
                            border border-[var(--editorial-border)]/50 shadow-xl
                            max-h-[60vh] overflow-y-auto animate-in fade-in slide-in-from-top-2 duration-300">
