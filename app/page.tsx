    ...
    <>
      ...
      >
        <main className="relative min-h-screen bg-[var(--editorial-bg)] text-[var(--editorial-text-primary)]">
          ...
          {/* Hero Section - Full viewport height Lovably-inspired layout */}
          <section className="min-h-screen flex flex-col px-6 md:px-10">
            <InteractiveHero />
          </section>

          {/* Content Section - Full width */}
          <div data-content-section className="w-full px-4 sm:px-6 md:px-10 mt-6 sm:mt-8">
            {/* Navigation bar */}
            <NavigationBar />
