 ...
 * This eliminates the need for client-side data fetching on initial load
 */
...
export default function HomePageClient({
  ...
  // OPTIMIZATION: Memoize grid calculations to prevent re-renders on unrelated state changes (e.g. chat input)
  const displayDestinations = useMemo(() => {
    return advancedFilters.nearMe && nearbyDestinations.length > 0
      ? nearbyDestinations
      : filteredDestinations;
  ...
  }, [viewMode, currentPage, itemsPerPage, displayDestinations]);
  ...
  // Swipe handlers for grid pagination
      ...
      >
                ...
                <div className="w-full">
                  ...
                  {submittedQuery && (
                    <div className="w-full">
                      ...
                      {/* Active Filters - Step Two spec: from user query */}
                      {inferredTags &&
                        !searching &&
                        (() => {
                          const activeTags =
        ...
        {isAdmin && (
          <div className="w-full px-6 md:px-10">
            ...
            {(() => {
              // Show empty state if no destinations and not in Near Me mode
